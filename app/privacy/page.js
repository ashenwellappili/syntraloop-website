          ...
          <ScrollReveal delay={100}>
            <div className="path-card max-w-4xl mx-auto p-8 space-y-6">
              ...
              <section>
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                  For any privacy enquiries or requests, please contact our engineering team at <strong className="text-blue-600 dark:text-cyan-400">syntraloop.contact@gmail.com</strong>.
                </p>
              </section>
            </div>
          </ScrollReveal>
